...
{#
    ...
    sales_dim_branch.sql/stg_customers.sql -- see there for the reasoning).
    Joins to sales_dim_branch on the natural branch key to pull in its
    ...
    null on sales_dim_branch, a Type 1 dimension with no history to version --
...
with base as (
    ...
    left join {{ ref('sales_dim_branch') }} b on s.branch = b.branch
