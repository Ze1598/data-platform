...
# connector_kind is nullable -- NULL means this feed's extraction/raw/clean
...
if mode == "Add new":
    ...
    connector_kind_label = st.selectbox(
        ...
        help="Which generic connector (processing/connectors/) generates this feed's extraction/raw/clean "
