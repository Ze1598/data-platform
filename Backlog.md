...
**Current priority (2026-07-15)**: platform solidity over new capability surface area. Phase 13 is now fully built (connector library, master pipeline, cherry-picking, dbt boilerplate reduction, ODS layer — see `Roadmap.md`/`Progress.md`); Phase 14 and working through this backlog are next; 11 and 12 remain deliberately deprioritized.
