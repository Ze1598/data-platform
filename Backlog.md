...
A first version of this page (`frontend/pages/7_Model_Table_Columns.py`, numbered `6_` at the time, see Progress.md's 2026-07-27 page-renumbering entry) was built and live-verified, but rejected by the user as not fit for purpose. Exact requirements for the rebuild, verbatim, not paraphrased:
